...
# print(np.array(grid_Points[0].coords))
plt.scatter(mask_xy[:,0], mask_xy[:,1])
plt.show()
# x,y = pillar1.exterior.xy
# plt.plot(x,y, 'k')
# x,y = pillar2.exterior.xy
# plt.plot(x,y, 'k')
# x,y = pillar3.exterior.xy
# plt.plot(x,y, 'k')
# x,y = pillar4.exterior.xy
# plt.plot(x,y, 'k')

# x,y = pillar1s.exterior.xy
# plt.plot(x,y, 'r')
# x,y = pillar2s.exterior.xy
# plt.plot(x,y, 'r')
# x,y = pillar3s.exterior.xy
# plt.plot(x,y, 'r')
# x,y = pillar4s.exterior.xy
# plt.plot(x,y, 'r')
